...
function RowNote({ note }) {
    return (
        <div className="flex items-center gap-4 bg-surface-muted-bg rounded-xl p-4">
            <h3 className="font-bold max-w-40 truncate">{note.title}</h3>
            <span className="bg-primary-bg/50 outline outline-surface-bg text-primary-fg px-4 py-0.5 rounded-full text-xs">
                {note.category}
            </span>
...
function NoteCard({ note }) {
    return (
        <div className="w-50 flex flex-col gap-3 bg-primary-bg text-primary-fg rounded-xl p-4">
            <h3 className="font-bold truncate">{note.title}</h3>
            <span className="bg-primary-bg/50 outline outline-surface-bg text-primary-fg px-4 py-0.5 rounded-full text-xs self-start">
                {note.category}
            </span>
